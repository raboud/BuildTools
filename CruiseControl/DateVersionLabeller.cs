...
namespace RandREng.CCNet.Plugin
{
	...
	public class DateVersionLabeller : ILabeller, ITask
	{
		...
		{
			return new Version(this.Major, this.Minor, GetBuildNumber(), 0);
		}

		private int GetBuildNumber()
		{
			return this.GetBuildNumber(this.StartDate, DateTime.Today);
		}

		private int GetBuildNumber(DateTime startDate, DateTime endDate)
		{
